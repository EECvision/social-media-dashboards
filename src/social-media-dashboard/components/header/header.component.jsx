...
const DashboardHeader=()=>{
    ...
    return(
        <div className={`w-full h-64 ${componentBg} flex justify-center items-start`}>
            <div className="w-full md:max-w-6xl flex md:flex-row flex-col justify-between md:items-center items-between mt-8 px-8 md:px-6">
                <div className="mb-4">
                ...
                <div className="sm:hidden border-t border-gray-500 py-2"></div>
